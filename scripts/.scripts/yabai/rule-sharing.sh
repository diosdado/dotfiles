...
yabai -m rule --apply app="^kitty$"             space=s_secondary
yabai -m rule --apply app="^Floorp$"            space=s_secondary
yabai -m rule --apply app="^Sandox\ Meet$"      space=s_main
yabai -m rule --apply app="^Microsoft\ Teams$"  space=s_main
yabai -m rule --apply app="^zoom.us$"           space=s_main
