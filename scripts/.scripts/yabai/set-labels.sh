...
spaces_numbers=($(/opt/homebrew/bin/yabai -m query --displays | /opt/homebrew/bin/jq 'sort_by(.index)|.[].spaces.[]'))
...
/opt/homebrew/bin/terminal-notifier -message "Reset Labels" -title "Yabai"
